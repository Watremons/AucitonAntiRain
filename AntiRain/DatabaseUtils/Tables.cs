...
using SqlSugar;
using FlagType = AntiRain.Resource.TypeEnum.GuildBattleType.FlagType;
...
namespace AntiRain.DatabaseUtils
{
    ...
    internal class AuctionInfo
    {
        ...
        /// 当前拍卖品的轮次
        /// </summary>
        [SugarColumn(ColumnName = "rid", ColumnDataType = "INTEGER")]
        ...
        /// 当前出价小组ID
        /// </summary>
        [SugarColumn(ColumnName = "curr_bidgroup", ColumnDataType = "INTEGER")]
        public long CurrBidGroup { get; set; }
        /// <summary>
        /// 拍卖会是否在进行中
        /// </summary>
    ...
    [SugarTable("auctionGroup")]
    internal class AuctionGroupInfo
    {
        /// <summary>
        /// 拍卖小组所在群号，同时标识所在拍卖会
        /// </summary>
        [SugarColumn(ColumnName = "aid", ColumnDataType = "INTEGER")]
        public long Aid { get; set; }

        /// <summary>
        /// 拍卖小组组号
        /// </summary>
        [SugarColumn(ColumnName = "gid", ColumnDataType = "INTEGER", IsIdentity = true, IsPrimaryKey = true)]
    ...
    internal class AuctionLot
    {
        ...
        /// 当前拍卖品的id
        /// </summary>
        [SugarColumn(ColumnName = "rid", ColumnDataType = "INTEGER", IsPrimaryKey = true)]
        public long Rid { get; set; }
