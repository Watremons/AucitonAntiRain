...
{
    internal class AuctionMgrDBHelper : BaseAuctionDBHelper
    {
        ...
        /// 数据库表名
        /// </summary>
        private string AuctionTableName { get; set; }
        #endregion

        #region 构造函数
        public AuctionMgrDBHelper(GroupMessageEventArgs eventArgs) : base(eventArgs)
        {
